...
{
    /**
      *  @var index to the doctrine DBAL 
      */
    const ADAPTER_INDEX = 'dbal_adapater';
    ...
    {
        return $this[self::ADAPTER_INDEX];
    }
    
    /**
      *  Sets the doctrine adapter
      *
      *  @access public
      *  @param Connection $adapter
      */
    public function setAdapter(Connection $adapter)
    {
       $this[self::ADAPTER_INDEX] = $adapter;
    }
    ...
    /**
      *  Return the lable Alias to $this::getLabel()
      *
      *  @access public
